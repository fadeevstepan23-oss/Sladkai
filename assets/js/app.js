...
(function () {
  ...
  var SERVICES = [
    { id: 'manicure',    cat: 'nails',  title: 'Маникюр с покрытием', price: 3200, dur: 90,
      tag: 'хит', img: 'assets/img/manicure.svg',
    ...
    { id: 'nail-design', cat: 'nails',  title: 'Дизайн и наращивание', price: 4800, dur: 150,
      tag: 'премиум', img: 'assets/img/color.svg',
    ...
    { id: 'pedicure',    cat: 'nails',  title: 'Педикюр SPA', price: 3900, dur: 90,
      tag: 'уход', img: 'assets/img/pedicure.svg',
    ...
    { id: 'lashes',      cat: 'lashes', title: 'Наращивание ресниц', price: 3500, dur: 120,
      tag: 'хит', img: 'assets/img/lashes.svg',
    ...
    { id: 'lamination',  cat: 'lashes', title: 'Ламинирование ресниц', price: 2900, dur: 70,
      tag: 'нежно', img: 'assets/img/skincare.svg',
    ...
    { id: 'brows',       cat: 'lashes', title: 'Брови: форма и окрашивание', price: 2200, dur: 60,
      tag: 'быстро', img: 'assets/img/brows.svg',
    ...
    { id: 'haircut',     cat: 'hair',   title: 'Стрижка и укладка', price: 3800, dur: 90,
      tag: 'стиль', img: 'assets/img/hair.svg',
    ...
    { id: 'facial',      cat: 'face',   title: 'Уход за лицом', price: 5600, dur: 90,
      tag: 'косметолог', img: 'assets/img/skincare.svg',
    ...
    { id: 'depilation',  cat: 'body',   title: 'Эпиляция воском / шугаринг', price: 1800, dur: 45,
      tag: 'деликатно', img: 'assets/img/interior-2.svg',
      desc: 'Гипоаллергенные составы, аккуратная техника и уход после процедуры.' }
  ];

  var MASTERS = [
    { id: 'alina',  name: 'Алина',   role: 'Nail-мастер',        exp: '9 лет в профессии, любит нюд и минимализм.', img: 'assets/img/manicure.svg' },
    { id: 'sofia',  name: 'София',   role: 'Lash & brow',        exp: 'Топ-мастер по ресницам, обучает новичков.',  img: 'assets/img/lashes.svg' },
    { id: 'polina', name: 'Полина',  role: 'Колорист',           exp: 'Сложные окрашивания и блонд без желтизны.',  img: 'assets/img/color.svg' },
    { id: 'vera',   name: 'Вера',    role: 'Косметолог',         exp: 'Уходовые протоколы и массаж лица.',          img: 'assets/img/skincare.svg' }
  ];
